...
/// Show Damage text effect over an entity's head
class DamageEffect {
  ...
  void addText(int damage, {bool isMine = false}) {
    damages.add(DamageText(damage, isMine: isMine));
  }
}
...
class DamageText {
  ...
  DamageText(this.damage, {this.isMine = false}) {
